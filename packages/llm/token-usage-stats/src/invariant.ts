/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-token-usage-stats`.
 * @module @deepseek-ai/dsh-token-usage-stats/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-token-usage-stats'
